...
(define (domain dominio2) ; definición del dominio
...
(:requirements :strips :fluents :typing) ; requisitos
    ...
    (:action Construir ; accion construir
        :parameters (?unidad - Unidades ?ed - Edificios ?x - Localizaciones ?rec - Recursos) ;  parametros
        :precondition (and 
            ...
            (exists (?tipo - tipoEdificio) (and ; existe el tipo de edificio y
                ...
                (recursoDisponible ?rec) ; rec está disponible 
                (edificioNecesita ?tipo ?rec) ; ed necesita rec
            ) )
        )
        :effect (and 
