...
(define (problem problema3) ; defición del problema

	(:domain dominio3) ; dominio donde se define
	...
	(:objects ; objetos
        ...
        VCE1 VCE2 VCE3 - Unidades ; unidades del problema
	...
	(:goal (and
		(entidadEn Barracones1 LOC34) ; objetivo: generar Gas
	))
)
